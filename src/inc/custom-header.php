	...
	?>
		<div class='logo_header'>
			<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
				<img src="http://i1.wp.com/cerroverde.ideapruebas.com/wp-content/uploads/2016/08/logo-header.jpeg" alt="Logo Header" />
			</a>
		</div>
	<?php 
}
...
function banner_header() {
	?>
		<picture>
			<img src="http://i0.wp.com/cerroverde.ideapruebas.com/wp-content/uploads/2016/08/banner-header.png" alt="Banner Header" />
		</picture>
	<?php 
}
